...
<div class="myprofile-board add-spread">
	<div class="card">
		...
		<div class="card-body">
			...
			<form action="<?php echo e(route('index.postSpread'), false); ?>" method="post" id="goods-form">
...
<?php $__env->startSection('js'); ?>
	<script>
		var status = "<?php echo e(session('status'), false); ?>";
		if (status) {
		    alert('添加成功');
		}
        $(document).on('click', '.btn-get-info', function () {
			...
			if(link.trim() == ''){
                ...
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(route('index.myprofile.addSpread'), false); ?>",
					data: {'link': link},
