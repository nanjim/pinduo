...
<?php if(!$goodsList->totalSize>0): ?>
    暂未找到相关产品
<?php else: ?>
<?php $__currentLoopData = $goodsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goods): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="goods-item card <?php echo e($goods->type == 0 ? 'user-goods' : '', false); ?>" data-id="<?php echo e($goods->id, false); ?>" data-goods_id="<?php echo e($goods->goods_id, false); ?>">
        <div class="card-body">
