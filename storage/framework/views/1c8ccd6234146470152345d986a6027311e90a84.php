<div class="search-wrap col-md-4 col-xs-12">
    <div class="logo">
        <img src="<?php echo e(URL::asset('img/site/huimaike.png'), false); ?>" alt="">
    </div>
...
<div class="cats col-md-4 col-xs-12">
    <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(isset($querys['cat_id']) && $querys['cat_id']==$cat->id): ?>
            <a href="<?php echo e(route('mobile.index.index', ['cat_id'=>$cat->id]), false); ?>"><div class="cat-item"><span class="def"><?php echo e($cat->name, false); ?></span></div></a>
        <?php else: ?>
            <a href="<?php echo e(route('mobile.index.index', ['cat_id'=>$cat->id]), false); ?>"><div class="cat-item"><span><?php echo e($cat->name, false); ?></span></div></a>
        <?php endif; ?>
