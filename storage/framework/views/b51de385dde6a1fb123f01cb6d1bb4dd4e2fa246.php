...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('注册'), false); ?></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register'), false); ?>">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('手机号'), false); ?></label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control<?php echo e($errors->has('mobile') ? ' is-invalid' : '', false); ?>" name="mobile" value="<?php echo e(old('mobile'), false); ?>" autofocus autocomplete="off">
        ...
        $("body").on('click','.get-code',function () {
            ...
            if(seconds==''){
                ...
                $.ajax({
                    type:"post",
                    url:"/sendMessage",
                    data:{'mobile': mobile, '_token': token, 'type': 1},
